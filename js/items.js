(function(window) {
	...
	window.flags = {
		...
		invertedactivatedflute: (query.f.charAt(12) === '1' ? true : false),
		...
		wildmaps: (query.f.charAt(18) === '1' ? true : false),
		wildcompasses: (query.f.charAt(19) === '1' ? true : false),
		wildkeys: (query.f.charAt(20) === '1' ? true : false),
